...
const EditTable = () => {
  ...
  useEffect(() => {
    if (TableData) {
      setTable_name(TableData?.table_name || "");
      setSeats(TableData?.seats || 0);
    }
  }, [TableData]);
  ...
  const handleSub = async (e) => {
    ...
    if (!reqBody.table_name || reqBody.seats === 0) {
  ...
  return (
    <div>
      <div className=" rounded-lg p-4 h-14 w-full bg-white flex justify-between items-center">
        <h1 className="font-semibold">EDIT Table</h1>
      </div>
